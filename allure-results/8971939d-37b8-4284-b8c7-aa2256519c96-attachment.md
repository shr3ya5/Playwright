...
```
Error: locator.textContent: Unexpected token " " while parsing css selector "table#product tbody tr: nth-child(4) td: nth-child(3)". Did you mean to CSS.escape it?
Call log:
  - waiting for table#product tbody tr: nth-child(4) td: nth-child(3)

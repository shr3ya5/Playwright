...
```ts
  ...
  16 |         let departureDate = page.locator('div[aria-disabled="false"][role="gridcell"]').nth(1);
  17 |         let returnDate = page.locator('div[aria-disabled="false"][role="gridcell"]').last();
  18 |         let searchButton = page.locator('p[data-cy="submit"] a').filter({hasText:"Search"});
...
> 27 |                 await page.goto(url, {waitUntil: "domcontentloaded"});
  ...
  56 |             await AIExpressFirstFlight.waitFor({state: "visible"});
  57 |         });

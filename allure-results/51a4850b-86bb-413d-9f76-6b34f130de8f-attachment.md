...
```ts
  ...
  16 |         let departureDate = page.locator('div[aria-disabled="false"][role="gridcell"][class=/DayPicker/]').first();
  17 |         let returnDate = page.locator('div[aria-disabled="false"][role="gridcell"][class=/DayPicker/]').last();

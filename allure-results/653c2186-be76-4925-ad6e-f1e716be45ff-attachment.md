...
- Name: HandsOnUseCases\RadiosCheckBoxesTables.spec.ts >> Handling Radios Checkboxes and Tables @RCT >> TS-03: Getting Text from Table
- Location: tests\HandsOnUseCases\RadiosCheckBoxesTables.spec.ts:54:9

# Error details

```
Error: locator.textContent: Error: strict mode violation: locator('table#product tbody tr:nth-child(3) td:nth-child(3)') resolved to 2 elements:
    1) <td>25</td> aka getByRole('cell', { name: '25' }).first()
    2) <td>Kolkata</td> aka getByRole('cell', { name: 'Kolkata' })

Call log:
  - waiting for locator('table#product tbody tr:nth-child(3) td:nth-child(3)')
...
```ts
  ...
  38 |         checkBox1 = await page.locator('input[value="option1"]');
  39 |         checkBox2 = await page.locator('input[value="option2"]')
  40 |         checkBox3 = await page.locator('input[value="option3"]')
  41 |         
  ...
  53 |     });
  54 |     test('TS-03: Getting Text from Table', {tag: '@smoke'}, async () => {
  55 |         tableText = await page.locator('table#product tbody tr:nth-child(3) td:nth-child(3)');

...
- Name: HandsOnUseCases\BrowserStack.spec.ts >> Browser Stack CSS Examples @CSS >> TS-02: Get Demo button
- Location: tests\HandsOnUseCases\BrowserStack.spec.ts:47:9
...
Call log:
  - waiting for getByRole('link', { name: /talk to us/i }).last()

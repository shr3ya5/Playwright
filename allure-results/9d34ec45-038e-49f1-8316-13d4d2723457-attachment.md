...
```ts
  ...
  33 |             console.log(`Dialog defaultValue: ${dialog.defaultValue}, 
  34 |                         + Dialog message: ${dialog.message}, Dialog type: ${dialog.type}`);
  35 |             dialog.dismiss();
  36 | 
  37 |         })
  38 |         //await closeModal.waitFor({state: "attached"});
  39 |         //await closeModal.click();

...
Call log:
  - waiting for locator('#dropdown-menu').locator('#dropdown-menu label[value="Apple"]')
...
> 38 |         await AppleOption.click({delay: 1000});
     |                           ^ Error: locator.click: Target page, context or browser has been closed
  39 | 
  40 |         let BananaOption = await selectFruitsDD.locator('#dropdown-menu label[value="Banana"]');

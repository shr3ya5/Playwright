...
- Location: tests\VisualRegressions.spec.ts:22:9

# Error details

```
Error: A snapshot doesn't exist at C:\HandsOn\tests\VisualRegressions.spec.ts-snapshots\wikipedia-chromium-win32.png, writing actual.
```

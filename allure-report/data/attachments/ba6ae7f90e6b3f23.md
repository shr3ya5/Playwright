...
Error: expect(Buffer).toMatchSnapshot(expected) failed
  ...
  15731 pixels (ratio 0.02 of all image pixels) are different.
...
```ts
  ...
  18 |         await page.waitForLoadState('domcontentloaded', {timeout: 10000});
...
> 20 |         await expect(await page.screenshot()).toMatchSnapshot('google.png');
  ...
  25 |         await page.waitForLoadState('domcontentloaded', {timeout: 10000});
